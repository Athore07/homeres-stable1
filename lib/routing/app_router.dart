...
import 'package:homeres/presentation/screens/settings/admin_profile_screen.dart';
...
final appRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      final isProfileSetup = state.matchedLocation == RouteNames.profileSetup;

      if (isSplash || isOnboarding || isProfileSetup) {
    ...
    routes: [
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(path: RouteNames.homeownerProfileScreen, builder: (_, _) => const HomeownerProfileScreen()),
          // Settings inside Shell with sub-routes
          GoRoute(
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(path: RouteNames.technicianProfileScreen, builder: (_, _) => const TechnicianProfileScreen()),
          GoRoute(path: RouteNames.notifications, builder: (_, _) => const NotificationsScreen()),
          // Settings inside Shell
          GoRoute(
            path: RouteNames.settings,
            builder: (_, _) => const SettingsScreen(),
            routes: [
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(path: RouteNames.adminProfileScreen, builder: (_, _) => const AdminProfileScreen()),
          GoRoute(path: RouteNames.notifications, builder: (_, _) => const NotificationsScreen()),
          // Settings inside Shell
          GoRoute(
            path: RouteNames.settings,
